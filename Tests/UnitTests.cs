...
namespace TravisCILab
{
    ...
    public class Math
    {
        ...
        public void Sub_Valid()
        {
            ...
            Assert.AreEqual(2, Program.Subtract("15", "13"));
            Assert.AreEqual(10, Program.Subtract("25", "15"));
        }
        [Test]
        ...
        public void Mult_Valid()
        {
            ...
            Assert.AreEqual(195, Program.Multiply("15", "13"));
            Assert.AreEqual(375, Program.Multiply("25", "15"));
        }
        [Test]
        ...
        {
            Assert.AreEqual(100000, Program.Power("10", "5"));
            Assert.AreEqual(225, Program.Power("15", "2"));
